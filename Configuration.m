classdef Configuration < handle
    ...
    methods
        ...
        function this = Configuration()
            ...
            this.sim.show_track_graphics = false;  % Display the paths of each robot
            ...
            this.scenario.num_robots = 2;               % Total number of robots
            this.scenario.num_obstacles = 4;            % Total number of obstacles
            this.scenario.num_targets = 2;              % Total number of targets
            ...
            % Robot Parameters
            this.scenario.robot_types =[ pi*(2/9)     2         0.30      1; ...
                                         pi*(2/9)     1         0.30      2; ...
                                         pi*(2/9)     1         0.30      3; ...
                                         pi*(2/9)     2         0.30      4];
                                       % Rotation  Strength   Step Size   Id
            this.scenario.target_types = [0.2, 1; 0.2, 1];
            this.scenario.robot_reach = 0.5;
            ...
            this.IL.reward_activation_dist = 0.15;  % Minimum distance to move to receive reward
            ...
            this.IL.num_state_vrbls = 7;            % Number of state variables for a robot
